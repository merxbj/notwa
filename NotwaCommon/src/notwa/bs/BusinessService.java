 ...
 * @version %I% %G%
 */
public interface BusinessService<TObject extends BusinessObject, TCollection extends BusinessObjectCollection<TObject>> {
    public int fill(TCollection boc);
    public int fill(TCollection boc, ParameterSet pc);
    public TObject get(Object primaryKey);
