...
public abstract class BusinessObjectCollection<T extends BusinessObject> extends ArrayList<T> {
     ...
     * process.
     * TODO: <MERXBJ> This is actualy a SmartResultSet, but i don't want to introduce
     * dependency from Common to Server. This should be either refactored, or 
     * kept until migration to Hybernate
     */
    protected Object dataContextReference;
     ...
     * @param dataContextReference The original <code>ResultSet</code> based which this
     *                  <code>BusinessObjectCollection</code> has been created.
     */
    public BusinessObjectCollection(Context currentContext, Object dataContextReference) {
        this.currentContext = currentContext;
        this.dataContextReference = dataContextReference;
    }
     ...
     *                  <code>BusinessObjectCollection</code> has been created.
     */
    public void setResultSet(Object dataContextReference) {
        this.dataContextReference = dataContextReference;
    }
     ...
     * the database can be easily updated.
     *
     * @return dataContextReference The original <code>ResultSet</code> based which this
     *                  <code>BusinessObjectCollection</code> has been created.
     */
    public Object getDataContextReference() {
        return dataContextReference;
    }
