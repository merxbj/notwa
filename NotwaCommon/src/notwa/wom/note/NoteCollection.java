...
public class NoteCollection extends BusinessObjectCollection<Note> {
    ...
    private static HashMap<Integer, Integer> nextWorkItemNoteId = new HashMap<Integer, Integer>() ;
     ...
     */
    public NoteCollection(Context context, Object dataContextReference) {
        super(context, dataContextReference);
    }
