...
public class Config {
    ...
    private Set<ServerConnectionInfo> connections = new TreeSet<ServerConnectionInfo>();
     ...
     */
    public Collection<ServerConnectionInfo> getConnecionStrings() {
        return connections;
    }
    ...
    public void setConnectionInfo(ServerConnectionInfo nci) {
        connections.add(nci);
    }
                ...
                if (node.getNodeName().equals("ApplicationSettings")) {
                    ...
                    for (int i=0; i<node.getChildNodes().getLength(); i++) {
                        ...
                        if (subNode.getNodeName().equals("Database")) {
                            ServerConnectionInfo nci = new ServerConnectionInfo();
    ...
    public void save() {
        try {
             ...
             */
            for (ServerConnectionInfo nci : connections) {
