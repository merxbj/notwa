...
public class IllegalSqlOperationException extends RuntimeException {
     ...
     * Default constructor.
     */
    public IllegalSqlOperationException() {
    }
     ...
     */
    public IllegalSqlOperationException(Throwable cause) {
        super(cause);
    }
     ...
     *              Usually refered to as inner exeption.
     */
    public IllegalSqlOperationException(String message, Throwable cause) {
        super(message, cause);
    }
}
