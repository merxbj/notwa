...
import notwa.server.sql.AnalyzableSql;
import notwa.server.sql.SqlFilter;
import notwa.common.Parameter;
import notwa.server.sql.analyzers.ParameterValueAnalyzer;
...
public class ProjectToUserAssignmentDal extends DataAccessLayer<User, UserCollection> {
     ...
     */
    public ProjectToUserAssignmentDal(DatabaseConnectionInfo ci, Context context) {
        super(ci, context);
    }
